...
function App() {
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10 rounded">   
      ...
      <input 
        className="w-full h-6 bg-gray-200 accent-lime-500 hover:lime-indigo-600" 
        type="range" 
      ...
      <div className='my-5 space-y-3 bg-gray-50 p-5'>
        ...
        <p className='text-xl text-gray-500 text-center font-bold'>{formatearDinero(mensualidad)}/mes</p>
      </div>
    </div>
